...
namespace BBC_Testing_Framework.Pages.BBC_Pages
{
    class HaveYourSayPage
    {
        ...
        public void ValidInputValue()
        {
            ...
            string validInput = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus posuere commodo enim quis gravida. Pellentesque habitant morbi turpis duis.";
            NavigateToTextForm();
        ...
        public void InvalidInputValue()
        {
            ...
            string invalidInput = "LLorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus posuere commodo enim quis gravida. Pellentesque habitant morbi turpis duis.";
            NavigateToTextForm();
